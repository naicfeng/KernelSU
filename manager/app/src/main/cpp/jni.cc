...
Java_org_cuojue_ksu_Natives_becomeManager(JNIEnv *env, jobject, jstring pkg) {
...
Java_org_cuojue_ksu_Natives_getVersion(JNIEnv *env, jobject) {
    return get_version();
}

extern "C"
JNIEXPORT jintArray JNICALL
Java_org_cuojue_ksu_Natives_getAllowList(JNIEnv *env, jobject) {
    int uids[1024];
    int size = 0;
...
Java_org_cuojue_ksu_Natives_getAppProfile(JNIEnv *env, jobject, jstring pkg, jint uid) {
    ...
    auto cls = env->FindClass("org/cuojue/ksu/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_org_cuojue_ksu_Natives_setAppProfile(JNIEnv *env, jobject clazz, jobject profile) {
    auto cls = env->FindClass("org/cuojue/ksu/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_org_cuojue_ksu_Natives_uidShouldUmount(JNIEnv *env, jobject thiz, jint uid) {
